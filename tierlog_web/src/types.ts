...
// being sent to the frontend. They are kept in the type only because the settings
// page depends on them; they must never be transmitted in full over the network.
export type User = {
  id: number;
  name: string;
  email: string;
